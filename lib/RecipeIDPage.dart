...
import 'package:food_receipe/model/IngredientID.dart';
import 'package:food_receipe/model/NutrientID.dart';
...
class _RecipeIdPageMainState extends State<RecipeIdPageMain> {
  ...
  String keyID =
      "/ingredientWidget.json?apiKey=9fab92e88fd74954ab99be625fcce7da";
  String url;
  String baseUrl2 = "https://api.spoonacular.com/recipes/";
  String keyID2 =
      "/nutritionWidget.json?apiKey=9fab92e88fd74954ab99be625fcce7da";
  String url2;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('Nutrient information',style:TextStyle(color:Colors.black54,fontSize:16,fontWeight: FontWeight.bold)),
                    SizedBox(
                      height: 5,
                    )        ,
                    ...
                    Text('Good nutrients',style:TextStyle(color:Colors.black54,fontSize:16,fontWeight: FontWeight.bold)),
                    SizedBox(
                      height: 5,
                    ),
                    _buildGoodNutrient(),
                    ...
                    Text('Bad nutrients',style:TextStyle(color:Colors.black54,fontSize:16,fontWeight: FontWeight.bold)),
                    SizedBox(
                      height: 5,
                    ),
                    _buildBaddNutrient(),
