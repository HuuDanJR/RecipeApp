...
class Recipe {
  ...
  Recipe({this.spoonacularSourceUrl, this.spoonacularScore, this.healthScore, this.creditsText, this.pricePerServing,this.extendedIngredients});


  factory Recipe.fromJson(Map<String,dynamic> parseJson){
    var list = parseJson['extendedIngredients'] as List;

    List<Ingredient> listExtend =  list.map((i) => Ingredient.fromJson(i)).toList();
