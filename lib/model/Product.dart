...
class Product{
  ...
  Product({this.id, this.title, this.price, this.likes, this.nutrition, this.serving_size, this.description, this.ingredientCount, this.ingredientList, this.ingredients, this.images});
  ...
  factory Product.fromJson(Map<String,dynamic> json){
    ...
    List<Ingredients> ingredientList = list2.map((i) => Ingredients.fromJson(i)).toList();
...
class Nutrition{
  ...
  factory Nutrition.fromJson(Map<String,dynamic> json){
    ...
    List<Nutrients> listNutrients = list4.map((f)=> Nutrients.fromJson(f)).toList();
