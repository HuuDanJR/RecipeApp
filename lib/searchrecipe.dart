...
import 'package:food_receipe/DropDown.dart';
import 'package:food_receipe/RecipeIDPage.dart';
import 'package:food_receipe/VideoPage.dart';
import 'package:food_receipe/VideoPlayer.dart';
import 'package:food_receipe/model/Search.dart';
...
class _SearchRecipePageState extends State<SearchRecipePage> {
  ...
  final String key = "&apiKey=9fab92e88fd74954ab99be625fcce7da";
  String url = "";
  String url2;
...
focusNode.unfocus();
          ...
          child: ListView(
            children: <Widget>[
              Padding(
                ...
                child: Text('FOOD RECIPES',style:TextStyle(color:Colors.blue,fontSize:16,fontWeight: FontWeight.w400,)),
              ),
              Container(
  ...
  //row search video
  _buildItemRow({String title,Color color,IconData icon,BuildContext context}){
                            ...
                            children: <Widget>[
                              GestureDetector(
                                  onTap: () {
                                    ...
                                    print('dialog value title: $_dialogValue dialog value controller text: ${_controller.text}');
