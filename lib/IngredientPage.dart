...
import 'package:food_receipe/model/Ingredient.dart';
...
class _IngredientMainPageState extends State<IngredientMainPage> {
  ...
  final response = await http.get('https://api.spoonacular.com/food/ingredients/substitutes?ingredientName=butter&apiKey=1a74b3a4abad4b11ba5a0de2815e5c41');
              ...
              child: FutureBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot){
                      ...
                      return Container(
                        ...
                        child: Padding(
                          ...
                          child: new Column(
                            ...
                            children: <Widget>[
                              Text('Ingredient: ${snapshot.data.ingredient}'),
                              Text('Message: ${snapshot.data.message}',style:TextStyle(color:Colors.grey)),
                              Container(
                                height:100,
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context,index){
                                    return Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: <Widget>[
                                    Text('-Sub${index}: ${snapshot.data.substitutes[index]}',style:TextStyle(color:Colors.black.withOpacity(.7))),
                    ...
                    itemCount: 1,
                      ...
                      return new Text('An error ocurr: ${snapshot.error.toString()}');
                    }
