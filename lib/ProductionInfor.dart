...
import 'package:food_receipe/model/Product.dart';
...
class _ProductInforPageState extends State<ProductInforPage> {
  ...
  Future<Product> _fetchProduct() async {
    final url =
        "https://api.spoonacular.com/food/products/22347?apiKey=9fab92e88fd74954ab99be625fcce7da";
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: <Widget>[
                                  _visibleIconUp  == true? IconButton(
                                        icon: Icon(Icons.arrow_upward,
                                            color: Colors.black45),
                                        onPressed: () {
                                          _moveDown();
                                          _controller.animateTo(
                                            _controller.offset - product.ingredients.length.toDouble(),
