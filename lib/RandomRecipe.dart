...
import 'dart:async';
import 'dart:convert';
import 'package:food_receipe/model/RecipeRD.dart';
import 'package:food_receipe/model/Recipe.dart';
...
Future <Recipes> _fecthRandomRecipe2() async {
  final respone  = await http.get("https://api.spoonacular.com/recipes/random?number=8&tags=lunch&apiKey=1a74b3a4abad4b11ba5a0de2815e5c41");
...
Future<RDRecipe> _fetchRandomRecipe() async {
  var link =
      "https://api.spoonacular.com/recipes/random?number=10&tags=lunch&apiKey=1a74b3a4abad4b11ba5a0de2815e5c41";
